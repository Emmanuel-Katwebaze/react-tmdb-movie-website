...
function TvShows() {
    ...
    const { results: movieResults } = tvShows;
    ...
    const fetchPopularTVshows = async (url, append) => {
    ...
    useEffect(() => {
        ...
        fetchFromAPI(`tv/popular`).then((data) => {
            if (data.status === 404) {
                setTVShows([]);
            } else {
                /* console.log(data); */
    ...
    return (
        <div>
            ...
            {pageLoading ? <div id="preloader"></div> : ""}
            {playing ? <div>
                <div className='overlay' onClick={closetvShowsection}></div>
                <YouTube
                    /* ref={containerRef} */
            ...
            <header className="header">
                <div className="container">
                    <div className="header-area">
                        <div className="logo">
                            <Link to="index-2.html"><img src="/assets/img/logo.png" alt="logo" /></Link>
                        ...
                        <div className="menu-area">
                            ...
                            <div className="mainmenu">
                                <ul id="primary-menu">
                                    ...
                                    <li><Link to="top-tvShows.html">Top tvShows</Link></li>
            ...
            {/* header section end  */}
            {/* hero area start */}
            <section className="hero-area" id="TvShows">
                <div className="container">
                                ...
                                <div className="row hero-area-slide" key={idx}>
                                    <div className="col-lg-6 col-md-5">
                                        <div className="hero-area-content">
                                            <img src={`${ORIGINAL_IMG_URL}${movie.poster_path}`} alt="about" />
                                        </div>
                                    </div>
                    ...
                    <div className="row flexbox-center">
                        <div className="col-lg-6 text-center text-lg-left">
                            <div className="section-title">
                                <h1><i className="icofont icofont-movie"></i>TV shows</h1>
                            </div>
                        </div>
